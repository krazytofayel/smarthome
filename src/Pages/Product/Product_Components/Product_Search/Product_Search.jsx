      ...
      <div>
        <form className="max-w-4xl mt-5 mb-5 ">
          ...
          <div className="relative">
            ...
            <button
              type="submit"
              className="text-white absolute end-2.5 bottom-2.5 bg-[#00ABE4] hover:bg-[#2e6172] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-[#00ABE4] dark:hover:bg-[#00ABE4] dark:focus:ring-[#00ABE4]"
            >
              Search
            </button>
          </div>
